...
echo "Sending results email for $YESTERDAY"
...
echo "Mapping tips to Betfair markets"
...
echo "Exporting BF Bot CSV"
node src/jobs/export-bfbot-tips.js daily "$TARGET_DATE"

echo "Publishing BF Bot CSV to GitHub Pages"
./tools/publish-bfbot-tips.sh daily "$TARGET_DATE"

echo "Sending tips email"
